...
class Sdi2324814SpringApplicationTests {
	...
	static String Geckodriver = "C:\\Users\\UO288780\\Downloads\\geckodriver-v0.30.0-win64.exe";
	...
	public void PR12() {
		...
		PO_PrivateView.checkPrivatePage(driver);
		PO_PrivateView.countNotes(driver, 2);
	...
	public void PR13() {
		PO_PrivateView.doLogin(driver, "99999990A", "123456");
		PO_PrivateView.checkPrivatePage(driver);
		PO_PrivateView.doChangePage(driver,0);
	...
	public void PR14() {
		...
		PO_PrivateView.checkPrivatePage(driver, "99999993D");
		String markDescription = "Nota sistemas distribuidos";
		PO_PrivateView.doAddMark(driver, 3, markDescription, "8.0");
		PO_PrivateView.checkMarkExists(driver, markDescription);
		PO_PrivateView.doLogout(driver);
	}
	...
	public void PR15() {
		...
		PO_PrivateView.checkPrivatePage(driver, "99999993D");
		String markDescription = "Nota sistemas distribuidos";
		PO_PrivateView.doDeleteMark(driver, markDescription);
		PO_PrivateView.checkMarkNotExists(driver, markDescription);
		PO_PrivateView.doLogout(driver);
	}
}
